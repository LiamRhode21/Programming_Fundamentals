...
student_name = "Liam Rhode"
Student_Name = "Rhode Liam"
print(student_name)
print(Student_Name)

# It treats them differenly because of the Upper-case and Lower-case
...
# The first one is just adding the strings together 10 then 5
# When they are numbers it adds the numbers together 15
...
print(f"{s_name} has {current_grade}% in {COURSE_NAME}")
...
# program_name = input("what program are you in: ")
# fav_program_lang = input("What is your favourite programming language: ")

# print(f"Name: {student_name} \nProgram: {program_name} \nFavourite language: {fav_program_lang}")
...
first_score = input("what is your first score: ")
bonus_score = input("what is your bonus score: ")
COURSE_NAME = "Introduction to python"

sum_string = first_score + bonus_score
sum_int = int(first_score) + int(bonus_score)

print("Student: " + name + "\nCourse: " + COURSE_NAME + "\nScores as strings: " + first_score + " + " + bonus_score + " = " + sum_string + "\nScores as numbers: " + first_score + " + " + bonus_score + " = " + str(sum_int) + "\n" + name + "'s " + "final grade in " + COURSE_NAME + " is " + str(sum_int) + "%")
